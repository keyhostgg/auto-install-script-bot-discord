...
install_nodejs() {
    ...
    # Tworzenie katalogu /etc/apt/keyrings jeśli nie istnieje
    mkdir -p /etc/apt/keyrings

    # Pobranie klucza GPG i zapisanie go w odpowiednim miejscu, nadpisanie jeśli istnieje
    ...
    # Aktualizacja listy pakietów z animacją
    ...
    # Wyświetlenie komunikatu po zakończeniu instalacji
...
# Wyświetlenie menu opcji dla Node.js
nodejs_options_menu() {
    while true; do
        echo -e "\e[1;30m===================================\e[0m"
...
# Wyświetlenie menu wyboru opcji
display_menu() {
    clear
    echo -e "\e[1;30m===================================\e[0m"
